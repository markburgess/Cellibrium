...
// These tuples might be generated by a code audit / scanner
 ...
 RoleCluster(stdout,"CGNgine error messages","error messages", "CGNgine", "fault diagnosis system errors faults");
 
 Gr(stdout,"CGNgine error messages",a_contains,"Cannot mix CIDR notation with xxx-yyy range notation *",ContextCluster(stdout,"system errors faults"));
 Gr(stdout,ContextCluster(stdout,"CGNgine error messages"),a_contains,"Not a valid address range - or not a fully qualified name *","system errors faults");
...
Gr(stdout,"incorrect use of network pattern matching",a_related_to,ContextCluster(stdout,"network pattern matching"), "system errors faults");
