...
static const BodySyntax setlabel_body = BodySyntaxNew("set_labels", classes_constraints, NULL, SYNTAX_STATUS_NORMAL);
...
{
    ConstraintSyntaxNewStringList("abortclasses", ".*", "A list of classes which if defined lead to termination of cgn-agent", SYNTAX_STATUS_NORMAL),
    ...
    ConstraintSyntaxNewStringList("agentaccess", ".*", "A list of user names allowed to execute cgn-agent", SYNTAX_STATUS_NORMAL),
    ConstraintSyntaxNewOption("agentfacility", CF_FACILITY, "The syslog facility for cgn-agent. Default value: LOG_USER", SYNTAX_STATUS_NORMAL),
    ...
    ConstraintSyntaxNewInt("maxconnections", CF_VALRANGE, "Maximum number of outgoing connections to cgn-serverd. Default value: 30 remote queries", SYNTAX_STATUS_NORMAL),
...
const ConstraintSyntax CFS_CONTROLBODY[SERVER_CONTROL_NONE + 1] =
{
    ...
    ConstraintSyntaxNewString("cfruncommand", CF_PATHRANGE, "Path to the cgn-agent command or cgn-execd wrapper for remote execution", SYNTAX_STATUS_NORMAL),
    ...
    ConstraintSyntaxNewInt("maxconnections", CF_VALRANGE, "Maximum number of connections that will be accepted by cgn-serverd. Default value: 30 remote queries", SYNTAX_STATUS_NORMAL),
...
const ConstraintSyntax CFEX_CONTROLBODY[] = /* enum cfexcontrol */
{
    ...
    ConstraintSyntaxNewStringList("schedule", "", "The class schedule used by cgn-execd for activating cgn-agent", SYNTAX_STATUS_NORMAL),
...
const ConstraintSyntax CFH_CONTROLBODY[] =  /* enum cfh_control */
{
    ...
    ConstraintSyntaxNewStringList("hub_schedule", "", "The class schedule used by cgn-hub for report collation", SYNTAX_STATUS_NORMAL),
...
const ConstraintSyntax CF_COMMON_BODIES[] =
{
    ...
    ConstraintSyntaxNewBody("set_labels", &setlabel_body, "Signalling behaviour (alias for classes)", SYNTAX_STATUS_NORMAL),
...
const PromiseTypeSyntax CF_COMMON_PROMISE_TYPES[] =
{
    ...
    PromiseTypeSyntaxNew("*", "labels", CF_CLASSBODY, &ClassesParseTreeCheck, SYNTAX_STATUS_NORMAL),
